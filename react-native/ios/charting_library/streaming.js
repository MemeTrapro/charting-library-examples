...
console.log("streaming.js starts loading");
...
window.subscribeOnStream = subscribeOnStream;
window.unsubscribeFromStream = unsubscribeFromStream;
console.log("streaming.js finishes loading");
